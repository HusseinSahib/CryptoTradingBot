  ...
  try {
    ...
    while(!sold){
      ...
      */
        ...
        (((parseFloat(intervals.data[intervalsNum-3][4])) - (parseFloat(intervals.data[intervalsNum-3][1])))>0)&&  
        (((parseFloat(intervals.data[intervalsNum-3][4])) - (parseFloat(intervals.data[intervalsNum-3][1])))>((parseFloat(intervals.data[intervalsNum-2][4])) - (parseFloat(intervals.data[intervalsNum-2][1]))))&&  
        (((parseFloat(intervals.data[intervalsNum-2][4])) - (parseFloat(intervals.data[intervalsNum-2][1])))<0)&&  
        (parseFloat(intervals.data[intervalsNum-2][3])) >= (parseFloat(intervals.data[intervalsNum-3][1]))&&
        (parseFloat(intervals.data[intervalsNum-2][2])) >= (((parseFloat(intervals.data[intervalsNum-3][4])) - (parseFloat(intervals.data[intervalsNum-3][1])))*2)
        ){
        const selling = await sell.sellOrder(stepSize,currentPrice,Coin,symbol);
